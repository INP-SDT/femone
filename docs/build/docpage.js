...
docPage.pagelogo = `<p id="logo-title">femone</p>`;
docPage.contents = `<p>
<ul>
    <li><a class="global-toc__top-item" href="femone.html">Modules</a>
        <ul>
            <li><a href="femone.fem.html">fem</a></li>
            <li><a href="femone.mesh.html">mesh</a></li>
        </ul>
    </li>
</ul>
</p>`;
